...
export default function Headline() {
    ...
    return (
      <div className="flex flex-col items-center justify-center text-center w-full px-4 gap-4">
        {/* Tagline */}
        <div className="bg-yellow-100 text-black px-6 py-2 w-[90%] md:w-[40%] lg:w-[30%] sm:w-[90%] rounded-[30px] shadow-lg font-bold">
          Lazy Money Framework Unveiled!
        </div>

        {/* Headline */}
        <h1 className="text-[28px] md:text-4xl lg:text-4xl font-extrabold leading-[110%] max-w-[90%] md:max-w-[80%]">
        ...
        {/* Subtitle */}
        <span className="text-[25px] md:text-4xl lg:text-3xl font-extrabold text-[#03031c] inline-block mt-[30px] underline leading-[110%]">
